...
<a class="navbar-brand" href="home.php"><img src="images/logo.png" height="60" width="60"></a>
  ...
  <div class="collapse navbar-collapse" id="navbarNav">
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link" href="general.php">Junior animals</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="#">Senior animals</a>
      </li>
      <span class="my-2 text">
...
<div class="container">
    <div class="card-deck">
    <?php
        $sql = "SELECT * FROM animals WHERE animal_status = 'senior'";
